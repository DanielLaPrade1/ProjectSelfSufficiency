package com.daniellaprade1.self_sufficiency_simulation.modules.simulation.domain.engine.impl;
...
public class SimulationEngineImpl implements SimulationEngine {
    ...
    public SimulationResult run(SimulationParameters parameters) {
        ...
        double totalCaloriesAvg = nutritionMetricResults.get("CALORIES").totals().midpoint();
        double targetCalories = nutritionMetricResults.get("CALORIES").target();
        double selfSufficiencyPercentage = (totalCaloriesAvg / targetCalories) * 100;
